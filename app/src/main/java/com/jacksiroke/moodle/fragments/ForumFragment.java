...
public class ForumFragment extends Fragment {
    ...
    public static ForumFragment newInstance(String token, int forumId) {
        return newInstance(token, forumId, "Site News");
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mClickListener = new ClickListener() {
            ...
            public boolean onClick(Object object, int position) {
                ...
                DiscussionFragment fragment = DiscussionFragment.newInstance(discussion.getDiscussion(), COURSE_NAME, TOKEN);
        ...
        courseRequestHandler.getForumDiscussions(FORUM_ID, new CallBack<List<Discussion>>()
        {
            ...
            public void onFailure(String message, Throwable t){
                ...
                if (dbDiscussions.size() == 0) {
                    mEmptyView.setVisibility(View.VISIBLE);
                    Toast.makeText(context, R.string.no_cached_data, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(context, R.string.loading_cached_data, Toast.LENGTH_SHORT).show();
                    mAdapter.clearDiscussions();
